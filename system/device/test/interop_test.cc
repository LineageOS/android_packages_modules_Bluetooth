...
TEST_F(InteropTest, test_name_hit) {
  ...
  EXPECT_TRUE(interop_match_name(INTEROP_DISABLE_LE_CONN_PREFERRED_PARAMS, "NMIabc"));
  EXPECT_TRUE(interop_match_name(INTEROP_DISABLE_LE_CONN_PREFERRED_PARAMS, "NM2XYZ"));
...
TEST_F(InteropTest, test_ssr_max_latency_miss) {
  ...
  EXPECT_FALSE(interop_database_match_addr_get_max_lat(INTEROP_UPDATE_HID_SSR_MAX_LAT, test_address,
                                                       &max_lat));
