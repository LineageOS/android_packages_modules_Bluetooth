...
class Modem(modem_grpc_aio.ModemServicer):
    ...
    https://cs.android.com/android/platform/superproject/main/+/main:packages/modules/Bluetooth/tests/pandora/interfaces/pandora/modem.proto
    """
