...
public class SdpDipRecordTest {
    ...
    public void writeToParcel() {
        ...
        assertThat(recordOut.getVendorId()).isEqualTo(originalRecord.getVendorId());
        assertThat(recordOut.getVendorIdSource()).isEqualTo(originalRecord.getVendorIdSource());
        assertThat(recordOut.getProductId()).isEqualTo(originalRecord.getProductId());
        assertThat(recordOut.getVersion()).isEqualTo(originalRecord.getVersion());
        assertThat(recordOut.getPrimaryRecord()).isEqualTo(originalRecord.getPrimaryRecord());
    }
}
