...
class Config:
    ...
    def load_from_dict(self, config: Dict[str, Any]) -> None:
        ...
        identity_address_type_name: str = config.get('identity_address_type', 'random').upper()
        self.identity_address_type = getattr(PairingConfig.AddressType, identity_address_type_name)
