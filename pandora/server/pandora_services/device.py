...
class PandoraDevice:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self._hci_name = config.get('transport',
                                    f"tcp-client:{config.get('tcp', ROOTCANAL_HCI_ADDRESS)}")
        self._hci = None
    ...
    async def open(self) -> None:
        ...
        self.device.host = Host(controller_source=self._hci.source,
                                controller_sink=self._hci.sink)  # type: ignore[no-untyped-call]
