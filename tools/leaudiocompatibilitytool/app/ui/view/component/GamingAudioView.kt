...
import android.bluetooth.tools.leaudiocompatibilitytool.app.viewmodel.GamingAudioViewModel
...
@Composable
fun GamingAudioView() {
    val viewModel: GamingAudioViewModel = hiltViewModel()
    val progressText by viewModel.progressString.collectAsStateWithLifecycle()

    TitleText(GamingAudioViewModel.TEST_ITEM_NAME)
    Column(modifier = ViewTheme.ScrollableColumnStyle) {
        ...
        ActionButton(onClickHandler = {}, text = "Play Music")
    }
