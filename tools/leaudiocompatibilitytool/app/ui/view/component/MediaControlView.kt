...
import android.bluetooth.tools.leaudiocompatibilitytool.app.viewmodel.MediaControlViewModel
...
fun MediaControlView() {
    val viewModel: MediaControlViewModel = hiltViewModel()
    val progressText by viewModel.progressString.collectAsStateWithLifecycle()

    DisposableEffect(Unit) {
        viewModel.initMediaControlTest()
        onDispose { viewModel.resetAndSaveMediaControlTest() }
    }

    TitleText(MediaControlViewModel.TEST_ITEM_NAME)
